...
#include <memory>
#include "../../practiceLPNU/loginform.h"
...
QT_MOC_LITERAL(1, 10, 17), // "loggingWasSuccess"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 22) // "on_LoginButton_clicked"

    },
    "LoginForm\0loggingWasSuccess\0\0"
...
void LoginForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->loggingWasSuccess(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginForm::loggingWasSuccess)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginForm::loggingWasSuccess()
{
